...
#	set_property IOSTANDARD LVCMOS33 [get_ports {WA[4]}]
#set_property PACKAGE_PIN V15 [get_ports {WA[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {WA[5]}]
#set_property PACKAGE_PIN W14 [get_ports {WA[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {WA[6]}]
#set_property PACKAGE_PIN W13 [get_ports {WA[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {WA[7]}]
#set_property PACKAGE_PIN V2 [get_ports {WA[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {WA[8]}]
#set_property PACKAGE_PIN T3 [get_ports {WA[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {WA[9]}]
#set_property PACKAGE_PIN T2 [get_ports {WA[10]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {WA[10]}]
#set_property PACKAGE_PIN R3 [get_ports {WA[11]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {WA[11]}]
#set_property PACKAGE_PIN W2 [get_ports {WA[12]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {WA[12]}]
